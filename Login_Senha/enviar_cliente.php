...
<body>
  ...
  <div class="container ">   
        <div class="col-sm-8">
          ...
          <label for="inputName" id="write">Nome</label>
        <input type="text" class="form-control" id="number" name ="nome"placeholder="Nome Completo" autofocus required >
         <br>
         <label for="inputtelefone" >Telefone</label>
        <input type="text" name="telefone" onKeyPress="MascaraTelefone(form1.telefone);" 
        maxlength="14"  onBlur="ValidaTelefone(form1.telefone);" class="form-control" placeholder="Telefone" required>
        <span id="teste"></span>
        <br>
  
        <label for="inputcpf" >CPF</label>
        <input type="text" name="cpf" onBlur="ValidarCPF(form1.cpf);" 
       onKeyPress="MascaraCPF(form1.cpf);" maxlength="14" class="form-control"  id="cpf" placeholder="CPF"  required>
        <span id="resultado"></span>
        <br>
        <label for="inputrg" >RG</label>
        <input name="rg" type="text" id="rg" size="30" maxlength="12" class="form-control" onKeyPress="MascaraRG(form1.rg);" placeholder="RG" />
        <br>
